...
# making a grid approximation for Riccardo
# density
dens <- 100
# define grid
...
cs.qa = map(
  alist(
    # correct answers predicted by # observations and true #
    c ~ dbinom(6,p), 
    # uniform prior (mean 0, sd 1)
    p ~ dunif(0,1) 
  ) ,
  # the observed correct answers
  data=list(c=3)) 
...
"Estimate all the teachers' knowledge of CogSci. Who's best? Use grid approximation. Comment on the posteriors of Riccardo and Mikkel. Produce plots of the prior, and posterior for each teacher."
...
# grab plot and save to variable  
  # temp <- grab_grob()
...
# how many values we want to pluck
  dens <- 1000
# define grid
  p_grid <- seq( from= 0 , to= 1 , length.out= dens )
# define prior
